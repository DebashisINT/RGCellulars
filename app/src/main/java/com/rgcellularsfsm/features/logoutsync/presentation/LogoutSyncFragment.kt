package com.rgcellularsfsm.features.logoutsync.presentation
...
import com.rgcellularsfsm.app.AppDatabase
import com.rgcellularsfsm.app.NetworkConstant
import com.rgcellularsfsm.app.Pref
import com.rgcellularsfsm.app.domain.*
import com.rgcellularsfsm.app.types.FragType
import com.rgcellularsfsm.app.utils.AppUtils
import com.rgcellularsfsm.app.utils.Toaster
import com.rgcellularsfsm.base.BaseResponse
import com.rgcellularsfsm.base.presentation.BaseActivity
import com.rgcellularsfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.rgcellularsfsm.features.billing.api.AddBillingRepoProvider
import com.rgcellularsfsm.features.billing.model.AddBillingInputParamsModel
...
import com.rgcellularsfsm.features.dashboard.presentation.ReasonDialog
...
import com.rgcellularsfsm.features.document.model.AddEditDocumentInputParams
import com.rgcellularsfsm.features.document.model.DocumentAttachmentModel
...
import com.rgcellularsfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.rgcellularsfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.rgcellularsfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.rgcellularsfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.rgcellularsfsm.features.orderhistory.model.*
...
import com.rgcellularsfsm.features.quotation.model.AddQuotInputModel
import com.rgcellularsfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.rgcellularsfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.rgcellularsfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.rgcellularsfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.rgcellularsfsm.features.timesheet.model.AddTimeSheetInputModel
import com.rgcellularsfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.rgcellularsfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.rgcellularsfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.rgcellularsfsm.mappackage.SendBrod
import com.rgcellularsfsm.widgets.AppCustomTextView
import com.rgcellularsfsm.MonitorService
import com.rgcellularsfsm.MySingleton
...
import com.rgcellularsfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.rgcellularsfsm.features.login.model.GetConcurrentUserResponse
import com.rgcellularsfsm.features.login.model.WhatsappApiData
import com.rgcellularsfsm.features.performance.model.Gps_status_list
import com.rgcellularsfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.rgcellularsfsm.features.returnsOrder.ReturnProductList
import com.rgcellularsfsm.features.returnsOrder.ReturnRequest
import com.rgcellularsfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrgcellularsfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrgcellularsfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrgcellularsfsmlogsample/log.zip").path);
