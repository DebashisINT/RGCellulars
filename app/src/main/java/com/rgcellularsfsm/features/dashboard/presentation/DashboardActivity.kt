package com.rgcellularsfsm.features.dashboard.presentation
...
import com.rgcellularsfsm.*
import com.rgcellularsfsm.R
import com.rgcellularsfsm.app.*
import com.rgcellularsfsm.app.NewFileUtils.browseDocuments
import com.rgcellularsfsm.app.NewFileUtils.browsePDFDocuments
import com.rgcellularsfsm.app.NewFileUtils.getExtension
import com.rgcellularsfsm.app.domain.*
import com.rgcellularsfsm.app.types.DashboardType
import com.rgcellularsfsm.app.types.FragType
import com.rgcellularsfsm.app.types.TopBarConfig
import com.rgcellularsfsm.app.uiaction.DisplayAlert
import com.rgcellularsfsm.app.utils.*
import com.rgcellularsfsm.app.utils.AppUtils.Companion.isProfile
import com.rgcellularsfsm.base.BaseResponse
import com.rgcellularsfsm.base.presentation.BaseActivity
import com.rgcellularsfsm.base.presentation.BaseFragment
import com.rgcellularsfsm.features.NewQuotation.*
import com.rgcellularsfsm.features.NewQuotation.api.GetQuotRegProvider
import com.rgcellularsfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.rgcellularsfsm.features.SearchLocation.SearchLocationFragment
import com.rgcellularsfsm.features.SearchLocation.locationInfoModel
import com.rgcellularsfsm.features.TA.ViewAllTAListFragment
import com.rgcellularsfsm.features.achievement.AchievementFragment
import com.rgcellularsfsm.features.activities.presentation.*
import com.rgcellularsfsm.features.addAttendence.*
import com.rgcellularsfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.rgcellularsfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.rgcellularsfsm.features.addAttendence.model.GetReportToFCMResponse
import com.rgcellularsfsm.features.addAttendence.model.GetReportToResponse
import com.rgcellularsfsm.features.addAttendence.model.Leave_list_Response
import com.rgcellularsfsm.features.addorder.presentation.AddOrderFragment
import com.rgcellularsfsm.features.addshop.model.AddShopRequestData
import com.rgcellularsfsm.features.addshop.model.AddShopResponse
import com.rgcellularsfsm.features.addshop.presentation.AddShopFragment
import com.rgcellularsfsm.features.addshop.presentation.OTPVerificationDialog
import com.rgcellularsfsm.features.addshop.presentation.ScanImageFragment
import com.rgcellularsfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.rgcellularsfsm.features.alarm.model.AlarmData
import com.rgcellularsfsm.features.alarm.presetation.AttendanceReportFragment
import com.rgcellularsfsm.features.alarm.presetation.PerformanceReportFragment
import com.rgcellularsfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.rgcellularsfsm.features.alarm.presetation.VisitReportFragment
import com.rgcellularsfsm.features.attendance.AttendanceFragment
import com.rgcellularsfsm.features.attendance.api.AttendanceRepositoryProvider
import com.rgcellularsfsm.features.attendance.model.AttendanceRequest
import com.rgcellularsfsm.features.attendance.model.AttendanceResponse
import com.rgcellularsfsm.features.averageshop.presentation.AverageShopFragment
import com.rgcellularsfsm.features.avgorder.presentation.AverageOrderFragment
import com.rgcellularsfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.rgcellularsfsm.features.beatCustom.TeamBeatListFragment
import com.rgcellularsfsm.features.billing.presentation.AddBillingFragment
import com.rgcellularsfsm.features.billing.presentation.BillingDetailsFragment
import com.rgcellularsfsm.features.billing.presentation.BillingListFragment
import com.rgcellularsfsm.features.changepassword.presentation.ChangePasswordDialog
import com.rgcellularsfsm.features.chat.model.ChatListDataModel
import com.rgcellularsfsm.features.chat.model.ChatUserDataModel
import com.rgcellularsfsm.features.chat.model.GroupUserDataModel
import com.rgcellularsfsm.features.chat.presentation.*
import com.rgcellularsfsm.features.chatbot.presentation.ChatBotFragment
import com.rgcellularsfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.rgcellularsfsm.features.chatbot.presentation.ReportsFragment
import com.rgcellularsfsm.features.chatbot.presentation.SelectLanguageDialog
import com.rgcellularsfsm.features.commondialog.presentation.CommonDialog
import com.rgcellularsfsm.features.commondialog.presentation.CommonDialogClickListener
import com.rgcellularsfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.rgcellularsfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.rgcellularsfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.rgcellularsfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.rgcellularsfsm.features.contacts.ContactDtls
import com.rgcellularsfsm.features.contacts.ContactGr
import com.rgcellularsfsm.features.contacts.ContactsAddFrag
import com.rgcellularsfsm.features.contacts.ContactsFrag
import com.rgcellularsfsm.features.contacts.SchedulerViewFrag
import com.rgcellularsfsm.features.contacts.SchedulerAddFormFrag
import com.rgcellularsfsm.features.contacts.TemplateAddFrag
import com.rgcellularsfsm.features.contacts.TemplateViewFrag
import com.rgcellularsfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.rgcellularsfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.rgcellularsfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.rgcellularsfsm.features.damageProduct.ShopDamageProductListFrag
import com.rgcellularsfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.rgcellularsfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.rgcellularsfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.rgcellularsfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.rgcellularsfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.rgcellularsfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.rgcellularsfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.rgcellularsfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.rgcellularsfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.rgcellularsfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.rgcellularsfsm.features.device_info.presentation.DeviceInfoListFragment
import com.rgcellularsfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.rgcellularsfsm.features.document.DocumentRepoFeatureNewFragment
import com.rgcellularsfsm.features.document.presentation.DocumentListFragment
import com.rgcellularsfsm.features.document.presentation.DocumentTypeListFragment
import com.rgcellularsfsm.features.document.presentation.OpenFileWebViewFragment
import com.rgcellularsfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.rgcellularsfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.rgcellularsfsm.features.dymanicSection.presentation.DynamicListFragment
import com.rgcellularsfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.rgcellularsfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.rgcellularsfsm.features.home.presentation.HomeFragment
import com.rgcellularsfsm.features.homelocation.presentation.HomeLocationFragment
import com.rgcellularsfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.rgcellularsfsm.features.know_your_state.KnowYourStateFragment
import com.rgcellularsfsm.features.lead.LeadFrag
import com.rgcellularsfsm.features.lead.ViewLeadFrag
import com.rgcellularsfsm.features.leaveapplynew.LeaveHome
import com.rgcellularsfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.rgcellularsfsm.features.localshops.LocalShopListFragment
import com.rgcellularsfsm.features.localshops.LocalShopListMapFragment
import com.rgcellularsfsm.features.localshops.NearByShopsMapFragment
import com.rgcellularsfsm.features.location.*
import com.rgcellularsfsm.features.location.api.LocationRepoProvider
import com.rgcellularsfsm.features.location.model.*
import com.rgcellularsfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.rgcellularsfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.rgcellularsfsm.features.login.ShopFeedbackEntity
import com.rgcellularsfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.rgcellularsfsm.features.login.presentation.LoginActivity
import com.rgcellularsfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.rgcellularsfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.rgcellularsfsm.features.marketAssist.MarketAssistTabFrag
import com.rgcellularsfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.rgcellularsfsm.features.marketAssist.ShopListMarketAssistFrag
import com.rgcellularsfsm.features.marketing.presentation.MarketingPagerFragment
import com.rgcellularsfsm.features.meetinglist.prsentation.MeetingListFragment
import com.rgcellularsfsm.features.member.MapViewForTeamFrag
import com.rgcellularsfsm.features.member.model.TeamLocDataModel
import com.rgcellularsfsm.features.member.model.TeamShopListDataModel
import com.rgcellularsfsm.features.member.presentation.*
import com.rgcellularsfsm.features.menuBeat.MenuBeatFrag
import com.rgcellularsfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.rgcellularsfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.rgcellularsfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.rgcellularsfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.rgcellularsfsm.features.myjobs.model.CustomerDataModel
import com.rgcellularsfsm.features.myjobs.presentation.*
import com.rgcellularsfsm.features.myorder.presentation.MyOrderListFragment
import com.rgcellularsfsm.features.myprofile.presentation.MyProfileFragment
import com.rgcellularsfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.rgcellularsfsm.features.nearbyshops.model.ShopData
import com.rgcellularsfsm.features.nearbyshops.model.ShopListResponse
import com.rgcellularsfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.rgcellularsfsm.features.nearbyshops.presentation.BeatListFragment
import com.rgcellularsfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.rgcellularsfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.rgcellularsfsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.rgcellularsfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.rgcellularsfsm.features.newcollection.CollectionDetailsStatusFragment
import com.rgcellularsfsm.features.newcollection.CollectionShopListFragment
import com.rgcellularsfsm.features.newcollection.NewCollectionListFragment
import com.rgcellularsfsm.features.newcollectionreport.*
import com.rgcellularsfsm.features.notification.NotificationFragment
import com.rgcellularsfsm.features.orderList.NewDateWiseOrderListFragment
import com.rgcellularsfsm.features.orderList.NewOrderListFragment
import com.rgcellularsfsm.features.orderList.OrderListFragment
import com.rgcellularsfsm.features.orderdetail.presentation.OrderDetailFragment
import com.rgcellularsfsm.features.orderhistory.ActivityMapFragment
import com.rgcellularsfsm.features.orderhistory.OrderhistoryFragment
import com.rgcellularsfsm.features.orderhistory.TimeLineFragment
import com.rgcellularsfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.rgcellularsfsm.features.orderhistory.model.FetchLocationRequest
import com.rgcellularsfsm.features.orderhistory.model.FetchLocationResponse
import com.rgcellularsfsm.features.orderhistory.model.LocationData
import com.rgcellularsfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.rgcellularsfsm.features.performance.GpsStatusFragment
import com.rgcellularsfsm.features.performance.PerformanceFragment
import com.rgcellularsfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.rgcellularsfsm.features.performance.model.UpdateGpsInputParamsModel
import com.rgcellularsfsm.features.performanceAPP.OwnPerformanceFragment
import com.rgcellularsfsm.features.performanceAPP.PerformanceAppFragment
import com.rgcellularsfsm.features.performanceAPP.allPerformanceFrag
import com.rgcellularsfsm.features.permissionList.ViewPermissionFragment
import com.rgcellularsfsm.features.photoReg.*
import com.rgcellularsfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.rgcellularsfsm.features.quotation.presentation.*
import com.rgcellularsfsm.features.reimbursement.presentation.*
import com.rgcellularsfsm.features.report.presentation.*
import com.rgcellularsfsm.features.returnsOrder.*
import com.rgcellularsfsm.features.settings.presentation.SettingsFragment
import com.rgcellularsfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.rgcellularsfsm.features.shopdetail.presentation.*
import com.rgcellularsfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.rgcellularsfsm.features.stock.StockDetailsFragment
import com.rgcellularsfsm.features.stock.StockListFragment
import com.rgcellularsfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.rgcellularsfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.rgcellularsfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.rgcellularsfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.rgcellularsfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.rgcellularsfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.rgcellularsfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.rgcellularsfsm.features.survey.SurveyFrag
import com.rgcellularsfsm.features.survey.SurveyViewDtlsFrag
import com.rgcellularsfsm.features.survey.SurveyViewFrag
import com.rgcellularsfsm.features.task.presentation.AddTaskFragment
import com.rgcellularsfsm.features.task.presentation.CalenderTaskFragment
import com.rgcellularsfsm.features.task.presentation.EditTaskFragment
import com.rgcellularsfsm.features.task.presentation.TaskListFragment
import com.rgcellularsfsm.features.taskManagement.TaskManagementFrag
import com.rgcellularsfsm.features.taskManagement.ViewTaskManagementFrag
import com.rgcellularsfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.rgcellularsfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.rgcellularsfsm.features.timesheet.presentation.TimeSheetListFragment
import com.rgcellularsfsm.features.viewAllOrder.CartFragment
import com.rgcellularsfsm.features.viewAllOrder.OrderTypeListFragment
import com.rgcellularsfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.rgcellularsfsm.features.viewAllOrder.ViewCartFragment
import com.rgcellularsfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.rgcellularsfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.rgcellularsfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.rgcellularsfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.rgcellularsfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.rgcellularsfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.rgcellularsfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.rgcellularsfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.rgcellularsfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.rgcellularsfsm.features.viewPPDDStock.ViewStockFragment
import com.rgcellularsfsm.features.weather.presentation.WeatherFragment
import com.rgcellularsfsm.mappackage.MapActivity
import com.rgcellularsfsm.mappackage.MapActivityWithoutPath
import com.rgcellularsfsm.mappackage.SendBrod
...
//            Log.w(TAG, errorMessage);
   ...
   /*     var fgg = getPhoneBookGroups()
       ...
       // Pref.IsShowCustomerLocationShare = true
        ...
        println("load_frag " + mFragType.toString() + "     " + Pref.user_id.toString()+" "+Pref.profile_img)
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xrgcellularsfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrgcellularsfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.rgcellularsfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrgcellularsfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrgcellularsfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrgcellularsfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrgcellularsfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
